...
# 映射字典
MAP_DICT = {'DOMAIN-SUFFIX': 'domain_suffix', 'PROCESS-NAME': 'process_name', 'HOST-SUFFIX': 'domain_suffix', 'host-suffix': 'domain_suffix', 'DOMAIN': 'domain', 'HOST': 'domain', 'host': 'domain',
